#!/usr/bin/perl
#
# extract_win_messages.pl
# Win message extractor for "Capcom vs. SNK 2" on the SEGA Dreamcast.
#
...
# Set input file.
my $input_file = "../gdi_original_extracted/MESJ_WIN.BIN";

# Set output files.
my $output_file = "MESJ_WIN.BIN.xls";
...
# Status message.
print "\n\"Capcom vs. SNK 2\" win message extractor for the SEGA Dreamcast.\n";
