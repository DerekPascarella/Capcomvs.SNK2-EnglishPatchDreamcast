   ...
   <li>
      ...
      <ul>
         <li>
            <b>Option 1</b>
            <br>
            Download <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/releases/download/1.1/Capcom.vs.SNK.2.-.Millionaire.Fighting.2001.English.v1.1.dcp">Capcom vs. SNK 2 - Millionaire Fighting 2001 (English v1.1).dcp</a> for use with <a href="https://github.com/DerekPascarella/UniversalDreamcastPatcher">Universal Dreamcast Patcher</a> v1.3 or newer.
         </li>
         <li>
            <b>Option 2</b>
            <br>
            Download <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/releases/download/1.1/Capcom.vs.SNK.2.-.Millionaire.Fighting.2001.English.v1.1.GDI.xdelta">Capcom vs. SNK 2 - Millionaire Fighting 2001 (English v1.1) [GDI].xdelta</a> for use with <a href="https://www.romhacking.net/utilities/704/">Delta Patcher</a> (or equivalent tools).
         </li>
      </ul>
   </li>
   <br>
   <li>
      ...
      <ul>
         <li>
            <b>Option 1</b>
            <br>
            Download <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/releases/download/1.1/Capcom.vs.SNK.2.-.Millionaire.Fighting.2001.English.v1.1.CDI.-.Audio-Data.Mode.xdelta">Capcom vs. SNK 2 - Millionaire Fighting 2001 (English v1.1) [CDI - Audio-Data Mode].xdelta</a> for use with <a href="https://www.romhacking.net/utilities/704/">Delta Patcher</a> (or equivalent tools).
         </li>
         <li>
            <b>Option 2</b>
            <br>Download <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/releases/download/1.1/Capcom.vs.SNK.2.-.Millionaire.Fighting.2001.English.v1.1.CDI.-.Data-Data.Mode.xdelta">Capcom vs. SNK 2 - Millionaire Fighting 2001 (English v1.1) [CDI - Data-Data Mode].xdelta</a> for use with <a href="https://www.romhacking.net/utilities/704/">Delta Patcher</a> (or equivalent tools).
         </li>
      </ul>
   </li>
</ul>
...
<ul>
   ...
   <li>
      ...
      <ol type="1">
         ...
         <li>Verify that the patched CDI has an MD5 checksum of <tt>F6D48683D5B5C579BB8FB91E5C6D5222</tt> if using the Data/Data mode patch, or <tt>0D5DF1536C1CA884E20A6D494E3DE735</tt> if using the Audio/Data mode patch.
      </ol>
   </li>
</ul>
<h2>Credits</h2>
...
<ul>
   <li><b>Version 1.1 (2025-07-02)</b></li>
   <ul>
      <li>Fixed message text error in "Color Edit Mode" (see <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/issues/1">issue #1</a>).</li>
      <li>Added support for exiting "Bonus Mode" while using a six-button controller (e.g., ASCII pad) by adding the A+B+X+Y button combination (see <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/issues/2">issue #2</a>).</li>
      <li>Corrected old Japanese character names cached in the 100% unlocked save bundled in "Bonus Mode" to reflect revised character names (see <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/issues/3">issue #3</a>).</li>
      <li>Fixed issue with some character portraits (see <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/issues/4">issue #4</a>).</li>
      <li>Fixed improper RGB SCART video initialization when the game detects a PAL console (see <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/issues/5">issue #5</a>).</li>
   </ul>
...
<ul>
   ...
   <li>Character portrait thumbnails have been cleaned up and improved.</li>
   <li><img src="https://i.imgur.com/XsUAGA0.png"> <b>IMPORTANT:</b> All post-battle dialogue that was previously unique to the Japanese version has been translated to English (around 5,100 instances). This dialogue is customized based on who is speaking, the defeated opponent to whom they're speaking, or the teammate to whom they're speaking.</li>
   <ul>
...
<br><br>
To return to the game from the bonus content section, either press the A+B+X+Y buttons simultaneously, or press the L Trigger on the controller, then select "EXIT TO GAME".
<br><br>
<ul>
   ...
   <br>
   <li><b>Developer Interviews</b><br>Interviews translated by <a href="https://itsfantastic.moe/">Benjamin Roodberg</a> from the October 15th, 2001 "Another Play Guide", featuring producers, graphic artists, sound engineers, planners, and programmers.</li>
</ul>
<h2>Known Issues</h2>
...
<br><br>
All other known issues or outstanding bugs <a href="https://github.com/DerekPascarella/Capcomvs.SNK2-EnglishPatchDreamcast/issues">can be found here</a>.
